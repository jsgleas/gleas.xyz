...
| Repo | Clear label | Product | Domain | Hosting recommendation | Status |
|---|---|---|---|---|---|
...
| `jsgleas/WAVY` | `game/wavy-surf` | Wavy surf browser game | `wavy101.com` / `play.wavy101.com` | Cloudflare Pages or Vercel | Active prototype |
| `jsgleas/gleas.xyz` | `storefront/gleas-xyz` | Umbrella brand/storefront | `gleas.xyz` | Shopify if commerce-first; Vercel/Cloudflare if content-first | Placeholder |
...
|---|---|---|
| `gleas.xyz` | Umbrella storefront and portfolio | Shopify or future `jsgleas/gleas.xyz` site |
...
| `wavy101.com` / `wavy101.co` | Wavy brand/game | `jsgleas/WAVY` deployment |
| `play.wavy101.com` | Direct Wavy game entry | Same deployment or game-only route |
...
- Build command: none
- Output directory: `/`
- Domains: `wavy101.com` or `wavy101.co`, `www`, optional `play`

### GLEAS.xyz

- If selling products/services directly: use Shopify.
- If building a custom portfolio first: turn this repo into a real website and host on Vercel/Cloudflare Pages.
